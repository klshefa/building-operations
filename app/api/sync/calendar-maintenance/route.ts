...
const CALENDAR_ID = 'c_f3a382bed8047ea9c4752c76b00336e7d484d88567928b7777e72c820f3cdbc8@group.calendar.google.com'
const SOURCE_NAME = 'calendar_maintenance'
...
export async function POST(request: Request) {
  ...
  try {
    await monitor.syncStart('calendar-maintenance-sync', 'google-calendar')
    ...
    console.log(`Fetched ${events.length} events from Maintenance Setups Calendar`)
    ...
    return NextResponse.json({
      success: true,
      message: `Synced ${rawEvents.length} Maintenance Setups calendar events`,
