...
const CALENDAR_ID = 'n7eelka44qs2fq2ke1r34e3ejk@group.calendar.google.com'
const SOURCE_NAME = 'calendar_admissions'
...
export async function POST(request: Request) {
  ...
  try {
    await monitor.syncStart('calendar-admissions-sync', 'google-calendar')
    ...
    console.log(`Fetched ${events.length} events from Admissions Events Calendar`)
    ...
    return NextResponse.json({
      success: true,
      message: `Synced ${rawEvents.length} Admissions Events calendar events`,
