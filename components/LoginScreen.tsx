    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          {/* Header */}
          <div className="bg-shefa-blue px-8 py-6 text-center">
            <div className="flex justify-center mb-4">
              <BuildingOffice2Icon className="w-12 h-12 text-white" strokeWidth={1.5} />
            </div>
            <h1 className="text-2xl font-bold text-white">Building Operations</h1>
            <p className="text-blue-200 text-sm mt-1">Manage building operations and events</p>
          </div>
        ...
        <p className="text-xs text-slate-400 text-center mt-6">
          © 2026 Shefa School. All rights reserved.
        </p>
      </div>
    </div>
  )
